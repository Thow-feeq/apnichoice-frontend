        ...
        <div className="bg-white shadow-lg rounded-lg p-8 space-y-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a target='blank' href="https://www.facebook.com/" className="text-white bg-blue-600 p-2 rounded-full hover:bg-blue-700 transition-all duration-200">
                <FaFacebookF />
              </a>
              <a target='blank' href="https://www.instagram.com/?hl=en" className="text-white bg-pink-500 p-2 rounded-full hover:bg-pink-600 transition-all duration-200">
                <FaInstagram  />
              </a>
